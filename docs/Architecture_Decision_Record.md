...
The interaction's UUID is generated by the client before submission.

This provides basic duplicate-submission protection without requiring a separate client interaction ID.
...
21. Nominatim provides MVP forward and reverse geocoding.
