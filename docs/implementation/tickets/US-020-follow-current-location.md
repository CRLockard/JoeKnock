...
Title: US-020 - Follow Current Location
...
As a sales representative, I want the map to follow my current position, so that I can walk through a neighborhood without manually repositioning the map.

# 3. Objective

Deliver the approved user-story outcome for Issue #20 with endpoint, authorization, and data behavior aligned to the finalized MVP architecture. The completed implementation should satisfy the acceptance criteria without expanding scope beyond this story.
