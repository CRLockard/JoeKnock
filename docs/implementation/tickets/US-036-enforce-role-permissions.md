...
Title: US-036 - Enforce Role Permissions
...
Deliver the approved user-story outcome for Issue #36 with endpoint, authorization, and data behavior aligned to the finalized MVP architecture. The completed implementation should satisfy the acceptance criteria without expanding scope beyond this story.

# 4. Scope

## 4.1 Included

- View permitted properties/interactions according to visibility rules.
- Create interactions.
