...
Title: US-013 - Remove User from Team
...
As a manager or administrator, I want to remove users from teams, so that team membership remains accurate.

# 3. Objective

Deliver the approved user-story outcome for Issue #13 with endpoint, authorization, and data behavior aligned to the finalized MVP architecture. The completed implementation should satisfy the acceptance criteria without expanding scope beyond this story.
