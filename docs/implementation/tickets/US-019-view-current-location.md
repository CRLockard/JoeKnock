...
Title: US-019 - View Current Location
...
As a sales representative, I want to see my current location on the map, so that I know where I am while canvassing.

# 3. Objective

Deliver the approved user-story outcome for Issue #19 with endpoint, authorization, and data behavior aligned to the finalized MVP architecture. The completed implementation should satisfy the acceptance criteria without expanding scope beyond this story.
