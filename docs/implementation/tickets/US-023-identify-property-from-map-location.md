...
Title: US-023 Î“Ã‡Ã¶ Identify Property from Map Location
...
- Preserve backend-mediated property resolution/geocoding boundary (`POST /api/properties/resolve`).
...
- Public geocoding endpoints are not part of MVP; geocoding remains internal to backend resolution.
