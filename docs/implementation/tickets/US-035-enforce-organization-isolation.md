...
Title: US-035 - Enforce Organization Isolation
...
- #2 login and protected auth context.
...
As a JoeKnock organization, I want my data isolated from other organizations, so that another organization cannot access our properties, users, or interactions.

# 3. Objective

Deliver the approved user-story outcome for Issue #35 with endpoint, authorization, and data behavior aligned to the finalized MVP architecture. The completed implementation should satisfy the acceptance criteria without expanding scope beyond this story.
...
- Phase 1 anchor ticket for cross-domain organization isolation.
