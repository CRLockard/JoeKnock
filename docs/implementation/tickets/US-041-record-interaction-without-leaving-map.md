...
Title: US-041 - Record Interaction Without Leaving Map
...
As a sales representative, I want to record an interaction from a map overlay, so that I can capture information quickly while standing at the property.

# 3. Objective

Deliver the approved user-story outcome for Issue #41 with endpoint, authorization, and data behavior aligned to the finalized MVP architecture. The completed implementation should satisfy the acceptance criteria without expanding scope beyond this story.
