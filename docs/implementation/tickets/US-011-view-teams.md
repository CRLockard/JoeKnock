...
As a manager or administrator, I want to view my organization's teams, so that I can manage team membership.

# 3. Objective

Deliver the approved user-story outcome for Issue #11 with endpoint, authorization, and data behavior aligned to the finalized MVP architecture. The completed implementation should satisfy the acceptance criteria without expanding scope beyond this story.
